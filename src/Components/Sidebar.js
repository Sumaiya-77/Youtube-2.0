    ...
    return (
        <>
            ...
            <div className={`max-w-[210px] fixed min-h-screen h-[100vh] z-20 sm:fixed ${showSideBar ? 'left-0' : 'left-[-220px]'} transition-all duration-300 bg-white dark:bg-neutral-900 dark:text-[#ffffff] dark:border-[#cfcdcd3e] border-r border-[#1313130c]  overflow-y-auto`}>
                ...
                <Link to={'https://github.com/'} target='_blank' rel='noopener noreferrer' className='flex items-start flex-col px-4 bg-white dark:bg-neutral-900 py-0 w-full font-medium'>
                        <h1 className='py-1.5'>Developed By</h1>
                        <div className='flex gap-2 items-center pb-2'>
                            <img src="https://avatars.githubusercontent.com/u/179369130?s=400&u=5682cebabec63ca5d513aab9bfc676c4b0b1dc64&v=4" alt="profile_pic" className='w-8 rounded-full'/>
                            <p className='font-normal'>Sumaiya</p>
                        </div>
                </Link>
